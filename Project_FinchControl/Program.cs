    ...
    class Program
    {
        ...
        static void DataRecorderDisplayMenuScreen(Finch finchRobot)
        {
            ...
            do
            {
                ...
                Console.WriteLine("\th) Write to Data File");
                Console.WriteLine("\tq) Main Menu");
                Console.Write("\t\tEnter Choice:");
                menuChoice = Console.ReadLine().ToLower();
                ...
                switch (menuChoice)
                {
                    ...
                    case "f":
                        ...
                        break;
                    case "g":
                        DataRecorderReadFromDataFile();
                        break;
                    case "h":
                        DataRecorderWriteToDataFile(finchRobot);
                        break;
                    case "q":
                        quitMenu = true;
                        break;
        ...
        private static void DataRecorderWriteToDataFile(Finch finchRobot)
        {
            string dataPath = @"Data\TempData.txt";
            double temperature = 0;

            temperature = ConvertToFarenheit(finchRobot.getTemperature());
            Console.WriteLine($"The temperature that will be recorded is: {temperature}");
            File.WriteAllText(dataPath, temperature.ToString());
            DisplayContinuePrompt();
            
        }

        private static void DataRecorderReadFromDataFile()
        {
            string dataPath = @"Data\TempData.txt";
            string tempInfo;

            tempInfo = File.ReadAllText(dataPath);
            Console.WriteLine($"Your last recorded temperature was: {tempInfo}");
            Console.WriteLine();
            DisplayContinuePrompt();
